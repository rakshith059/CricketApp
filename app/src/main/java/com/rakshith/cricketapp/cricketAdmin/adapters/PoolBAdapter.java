 ...
 */
public class PoolBAdapter extends RecyclerView.Adapter<PoolBAdapter.TeamsViewHolder> implements View.OnClickListener {
    ...
    public void updatePoolBList(Activity mActivity, List teams) {
